...
<body>
  <jsp:include page="/header.jsp" />
   ...
   Statement st = con.createStatement();
    ResultSet rs;
    //change this
    rs = st.executeQuery("select name from (select name , avg(fee) as avg_univ_fee from university u, finance f where f.unid = u.unid and u.rank <= 100 and avg_univ_fee < 50000)");  
